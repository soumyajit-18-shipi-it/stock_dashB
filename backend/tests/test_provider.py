...
def test_provider_returns_latest_daily_candle(provider: StockDataProvider) -> None:
...
def test_provider_returns_missing_statistics(provider: StockDataProvider) -> None:
    mock_ticker = MagicMock()
